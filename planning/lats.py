...
from .models import EnvironmentFeedback, LATSNode, LATSResult
...
def lats(
    ...
    Compact MCTS loop with action generation, a value function,
    external environment feedback, branch reflection, UCT selection, and value backpropagation.
    Adapted directly from AmrSheta22/task_decomposition_and_planning reference toolkit.
    """
